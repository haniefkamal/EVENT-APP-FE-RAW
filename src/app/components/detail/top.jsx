...
import EventBreadcrumb from "./top-breadcrumbs";
...
function ContentTop() {
  ...
  //   const calculateLineClamp = (title) => {
  //     const words = title.split(" ").length;
  //     return words > 4 ? "" : "line-clamp-2";
  //   };
    ...
    <>
      <div className="event-section-container ">
        <div className="event-content-top-wrapper mb-5">
          <div className="event-content-top-header">
            <EventBreadcrumb />
          </div>
          <div className="flex">
            {/* DETAIL EVENT IMAGE */}
            <div className="w-full">
              <img
                className="rounded-2xl w-[720px] h-[400px]"
          ...
          {/* DETAIL CARD */}
          <div className="event-content-top-card line-clamp-2 ">
            {/* event-title */}
            <div className="event-title text-xl mb-5">
              {selectedEvent.title}
            </div>
            {/* event-date */}
            <div className="grid mb-4">
              <div className="flex gap-2 py-1">
                <Calendar color="black" fill="#F2CD5C" />
                <div className="flex"> {selectedEvent.date}</div>
              </div>
              {/* event-time */}
              <div className="flex gap-2 py-1">
                <Clock color="black" fill="#F2CD5C" />
                <div className="flex"> {selectedEvent.time}</div>
              </div>
              {/* event-location */}
              <div className="flex gap-2 py-1">
                <MapPin color="black" fill="#F2CD5C" />
                <div className="flex"> {selectedEvent.location}</div>
              </div>
            </div>
            ...
            <div className="my-2 font-bold">
              <div className="flex justify-between">
                ...
                <div className="flex justify-end text-xl  text-red-400">
                  `stock status`
                </div>
              </div>
            </div>
            ...
            {/* CREATOR */}
            <div className="my-4">
              <div className="flex items-center border-t-2 pt-2 mt-5">
                <div className="flex mr-3">
                  {/* creator-logo */}
                  <div className="w-10 h-10">
                    <img
                      className="inline-block rounded-full object-cover flex-shrink-0 w-full h-full"
                ...
                <div className="grid-rows-2">
                  <div className="text-[#A9AAB2]">organized by</div>
            ...
            {/* BUTTON */}
            <div className="">
              <Button fullWidth color="amber" size="large">
                <div>BUY</div>
              </Button>
            </div>
          </div>
