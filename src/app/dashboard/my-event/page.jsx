...
import NavbarDashboardOrganizer from "@/app/components/dashboard/organizer/navbar";
    ...
    <>
      <div className="flex min-h-screen">
        ...
        <div className="w-full">
          ...
          {/* MAIN MY-EVENT CONTENT DASHBOARD */}
          <div className="m-8">
            <div className="relative grid grid-cols-3 gap-5">
              {/* CARDS */}
              {myeventCards.map((myeventCard) => (
                <div
                  key={myeventCard.id}
                ...
                >
                  <img
                    ...
                    src={myeventCard.thumbnail}
                    alt="card"
                  />
                  <div className="card-event-description">
                    <div className="description-title">{myeventCard.title}</div>
                    <div className="description-date">{myeventCard.date}</div>
                    <div className="description-price">
                      {myeventCard.price === 0
                        ...
                        : new Intl.NumberFormat("id-ID", {
                          ...
                          }).format(myeventCard.price)}
                    </div>
                  </div>
                  <div className="card-event-editor items-center justify-center">
          ...
          {/* END MY-EVENT CONTENT DASHBOARD */}
        </div>
      </div>
    </>
  );
