    ...
    <>
      ...
      <div className="home-wrapper bg-[#FBFBFB]">
        <div className="explore-section-container">
          <div className="flex">
            {/* SIDEBAR */}
            <div className="w-[256px] border-r-2">
              <div className="mr-5">
            ...
            <div className="ml-5">
              <div className="justify-end">
                ...
                <div className="section-title mb-5">
                  reserved for header of content
                </div>
                {/* CONTENT Cards */}
                <div className="section-content mb-10">
                  {/* CARDS */}
                  {exploreCards.map((exploreCard) => (
                    <div
                      key={exploreCard.id}
                      className="card-explore overflow-hidden"
                    >
                      <img
                        className="card-explore-thumbnail"
                        src={exploreCard.thumbnail}
                        alt="explorecards"
                      />
                      <div className="card-explore-description">
                        ...
                        <div className="description-price">
                          {exploreCard.price === 0
                            ...
                            : new Intl.NumberFormat("id-ID", {
                              ...
                              }).format(exploreCard.price)}
                        </div>
                      </div>
                      <div className="card-explore-creator">
                        <img
                          className="ml-2 inline-block rounded-full object-scale-down w-10 h-10"
                          src={exploreCard.logo}
                          alt=""
                        />
                        <div className="ml-3">{exploreCard.creator}</div>
                      </div>
                    </div>
                  ))}
                </div>
                {/* CONTENT Pagination */}
                <div className="section-pagination p-2 text-center">
